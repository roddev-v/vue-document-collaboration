<template>
  <PageWrapper>
    <section class="content-section">
      ...
      <NoDocuments
        v-if="documentsStore.empty"
        msg="You have no documents created!"
      ></NoDocuments>
      <DocumentsList
    ...
    <section class="content-section">
      ...
      <NoDocuments
        v-if="documentsStore.emptyShared"
        msg="You have no documents created!"
      ></NoDocuments>
    ...
    >
      ...
      <Message severity="error" v-if="documentsStore.error" :closable="false">{{
